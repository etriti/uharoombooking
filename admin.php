...
else
{
  ...
  else
  {
    ...
    echo "<br>";
    echo "<select class=\"room_area_select form-control\" id=\"area_select\" name=\"area\" onchange=\"this.form.submit()\">";
    if ($is_admin)
    {
      if ($areas[0]['disabled'])
      {
    ...
    echo "<br>";
    //echo "<input type=\"submit\" name=\"change\" class=\"js_none btn btn-warning\" value=\"" . get_vocab("change") . "\">\n";
...
if ($is_admin)
{
  ...
  <form id="add_area" class="form_admin" action="add.php" method="post">
    ...
    <legend><?php echo get_vocab("addarea") ?></legend>
      ...
      <br>
      <div>
        <input type="submit" class="submit btn btn-primary" value="<?php echo get_vocab("addarea") ?>">
      </div>
      <br>
    </fieldset>
  </form>
  ...
  if (isset($area))
  {
    ...
    else
    {
      ...
      else
      {
        ...
        // database)
        echo "<table id=\"rooms_table\" class=\"admin_table display table table-striped\">\n";
    ...
    <form id="add_room" class="form_admin" action="add.php" method="post">
      ...
      <legend><?php echo get_vocab("addroom") ?></legend>
        ...
        <div>
          ...
          <input class="form-control" type="text" id="room_name" name="name" maxlength="<?php echo $maxlength['room.room_name'] ?>">
        </div>

        <div>
          <label for="room_description"><?php echo get_vocab("description") ?>:</label>
          <input class="form-control" type="text" id="room_description" name="description" maxlength="<?php echo $maxlength['room.description'] ?>">
        </div>

        <div>
          <label for="room_capacity"><?php echo get_vocab("capacity") ?>:</label>
          <input class="form-control" type="text" id="room_capacity" name="capacity">
        </div>

        <div>
          <label for="room_admin_email"><?php echo get_vocab("room_admin_email") ?>:</label>
          <input class="form-control" type="text" id="room_admin_email" name="room_admin_email">
        </div>
        <br>
        <div>
          <input type="submit" class="submit btn btn-primary" value="<?php echo get_vocab("addroom") ?>">
        </div>
        <br>
        <br>
        <br>
