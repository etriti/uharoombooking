...
<nav class=\"date_nav\">
  <a class=\"date_before\" href=\"$href_before\"><span class='glyphicon glyphicon-chevron-left' aria-hidden='true'></span>" . get_vocab("daybefore") . "</a>
  <a class=\"date_now\" href=\"$href_now;\">" . get_vocab("gototoday") . "</a>
  <a class=\"date_after\" href=\"$href_after\">" . get_vocab("dayafter") . "<span class='glyphicon glyphicon-chevron-right' aria-hidden='true'></span></a>
</nav>";
// and output them
echo $before_after_links_html;

echo "<table class=\"dwm_main table table-striped table-bordered table-hover\" id=\"day_main\" data-resolution=\"$resolution\">\n";
echo $inner_html;
echo "</table>\n";
