...
if ($type == "room")
{
  ...
  else
  {
    ...
    echo "<a href=\"del.php?type=room&amp;area=$area&amp;room=$room&amp;confirm=Y\"><span class='glyphicon glyphicon-ok' id=\"del_yes\">" . get_vocab("YES") . "</span></a>\n";
    echo "<a href=\"admin.php\"><span class='glyphicon glyphicon-remove' id=\"del_no\">" . get_vocab("NO") . "</span></a>\n";
    echo "</div>\n";
    echo "</div>\n";
    //output_trailer();
  }
