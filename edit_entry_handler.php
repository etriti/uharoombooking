...
else
{
  ...
  if (!empty($result['conflicts']))
  {
    ...
    {
      echo "<li class='list-group-item'>$conflict</li>\n";
    }
    echo "</ul>\n";
    echo "</div>";
  }
...
echo "<input class='btn btn-info back_button' type=\"submit\" value=\"" . get_vocab("back") . "\">\n";
echo "</fieldset>\n";
echo "</form>\n";
echo "<br>";
    ...
    isset($rep_type) && ($rep_type != REP_NONE))
{
  ...
  // Submit button
  echo "<input class='btn btn-danger submit_button' type=\"submit\"" .
