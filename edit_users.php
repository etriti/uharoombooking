  ...
  print "<form id=\"form_edit_users\" method=\"post\" action=\"" . htmlspecialchars(this_page()) . "\">\n";
    ?>
        ...
        <div id="edit_users_input_container">
          ...
          <input class="submit default_action btn btn-success" type="submit" value="<?php echo(get_vocab("save")); ?>">
      ...
      if (($Id >= 0) && ($level >= $min_user_editing_level) && ($level >= $data['level']))
      {
        ...
        echo "<input type=\"hidden\" name=\"Id\" value=\"$Id\">\n";
        echo "<input class=\"submit btn btn-danger\" type=\"submit\" " .
      ...
      else
      {
        echo "<form id=\"form_delete_users\" method=\"post\" action=\"" . htmlspecialchars(this_page()) . "\">\n";
        echo "<div>\n";
        echo "<input class=\"submit btn btn-danger\" type=\"submit\" value=\"" . get_vocab("back") . "\">\n";
        echo "</div>\n";
        echo "</form>\n";
        echo "<br>";
        echo "<br>";
...
if (!$ajax)
{
  ...
  if ($level >= $min_user_editing_level) /* Administrators get the right to add new users */
  {
    ...
    print "    <input class='btn btn-success' type=\"submit\" value=\"" . get_vocab("add_new_user") . "\">\n";
    print "  </div>\n";
    print "  <br>\n";
    print "</form>\n";
  }
...
if ($initial_user_creation != 1)   // don't print the user table if there are no users
{
  ...
  if (!$ajax)
  {
    ...
    echo "<table class=\"admin_table display table table-hover\" id=\"users_table\">\n";
