...
echo "<div id=\"dwm_header\" class=\"screenonly dwm_header-month\">\n";
...
echo "</div>\n";
echo "<div class='alert alert-info message-month-page' role='alert'>";
  echo "<span class='glyphicon glyphicon-info-sign' aria-hidden='true'></span>";
  echo "<span class='sr-only'>Error:</span>";
  echo " Ups.. Afin de consulter le tableau complet du mois et de la salle choisie, il vous faut un écran de largeur supérieure à 686 pixels.";
echo "</div>";
...
echo "<div id=\"dwm\" class='month_title_display'>\n";
...
<nav class=\"date_nav date_nav_display\">
  <a class=\"date_before\" href=\"$href_before\"><span class='glyphicon glyphicon-chevron-left' aria-hidden='true'></span>" . get_vocab("monthbefore") . "</a>
  <a class=\"date_now\" href=\"$href_now\">" . get_vocab("gotothismonth") . "</a>
  <a class=\"date_after\" href=\"$href_after\">" . get_vocab("monthafter") . "<span class='glyphicon glyphicon-chevron-right' aria-hidden='true'></span></a>
</nav>\n";
...
echo "<table class=\"dwm_main table table-striped\" id=\"month_main\">\n";
echo $inner_html;
echo "</table>\n";
